    ...
    <AdminLayout>
      <header className="mb-10 flex items-end justify-between">
        ...
        <Button
          ...
          className="h-auto rounded-lg bg-[#001e40] px-12 pb-[12.5px] pt-[11.5px] shadow-[0px_1px_2px_#0000000d] hover:bg-[#001e40]/90"
        >
          <img
          ...
          />
          <span className="flex h-6 items-center justify-center [font-family:'Public_Sans',Helvetica] text-base font-normal leading-6 tracking-[0] text-white whitespace-nowrap ml-2">
            Simpan Perubahan
          </span>
        </Button>
      </header>
          ...
          <CardContent className="flex flex-col gap-6 p-6">
            ...
            <div className="flex flex-col gap-6">
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col items-start gap-3 self-stretch">
                    ...
                    <div className="flex w-full items-start justify-end pt-2">
                      <Button
                        data-testid={`button-hapus-slider-${index}`}
                        variant="ghost"
                      ...
                      >
                        ...
                        />
                        <span className="mt-[-1.00px] flex h-6 items-center justify-center [font-family:'Inter',Helvetica] text-base font-normal leading-6 tracking-[0] text-center whitespace-nowrap">
                          Hapus
                        </span>
                      </Button>
                    </div>
              ...
              >
                ...
                />
                <span className="flex h-6 items-center justify-center [font-family:'Inter',Helvetica] text-base font-normal leading-6 tracking-[0] text-center whitespace-nowrap">
                  Tambah Banner Baru
                </span>
              </Button>
            </div>
          ...
          <Card className="w-full rounded-xl border-0 bg-[#003366] shadow-[0px_1px_2px_#0000000d]">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                <img className="h-[25px] w-[25px] shrink-0" alt="Icon" src="/figmaAssets/icon.svg" />
                <div className="inline-flex flex-col items-start gap-[6.75px]">
                  <h3 className="mt-[-1.00px] flex h-6 items-center [font-family:'Inter',Helvetica] text-base font-bold leading-6 tracking-[0] text-white whitespace-nowrap">
                    Tip Optimasi Gambar
                  </h3>
                  <p className="mt-[-1.00px] [font-family:'Inter',Helvetica] text-sm font-normal leading-[22.8px] tracking-[0] text-[#799dd6] opacity-90">
                    Gunakan gambar dengan rasio 16:9 dan resolusi minimal 1920×1080px untuk hasil
                    terbaik pada slider utama. Pastikan ukuran file di bawah 500KB untuk kecepatan
                    akses.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                {generalContents.map((item, index) => (
                  <button
                    ...
                    data-testid={`button-konten-general-${index}`}
                    type="button"
                  ...
                  >
                    <span className="inline-flex items-center gap-[11.99px]">
                      <img className="relative flex-[0_0_auto]" alt="Container" src={item.icon} />
